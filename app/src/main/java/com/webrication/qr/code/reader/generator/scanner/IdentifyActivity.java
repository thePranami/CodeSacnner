...
public class IdentifyActivity extends AppCompatActivity {
    ...
    ImageView share_btn;
    String qr_latitude=null;
    String qr_longitude=null;

    LinearLayout linearLayout;
    Context context;
    RelativeLayout contact,call,email,share,event,browser,map,web;
    String contents="";
    String Email="";
    String Name="";
    String Tel="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView)findViewById(R.id.image_identy);
        ...
        event=(RelativeLayout)findViewById(R.id.wifi);
        email=(RelativeLayout)findViewById(R.id.email);
        browser=(RelativeLayout)findViewById(R.id.browser);
    ...
    public void EventHandler()
    {
        adapter.SetOnItemClickListener(new RecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                {
                    if ( contents !=null&&!contents.equals("null")&&!contents.isEmpty()) {
                ...
                else if (text.equalsIgnoreCase("contact"))
                {
                    ...
                    {
                        ActivityCompat.requestPermissions(IdentifyActivity.this,
...
//                i.putExtra(Intent.EXTRA_TEXT   , "body of email");
    ...
    public void QRcodeReader(Bitmap mybitmap)
    {
        int width = mybitmap.getWidth();
        int height = mybitmap.getHeight();
        int[] pixels = new int[width * height];
        mybitmap.getPixels(pixels, 0, width, 0, 0, width, height);
        Log.e("hight", String.valueOf(height));
        ...
        try {
           ...
           name.setText("Not Valid QRcode Image" );
            name.setTextSize(20);
            name.setPadding(10, 20, 10, 2);
            ...
            name.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,
                    LinearLayout.LayoutParams.WRAP_CONTENT));
            name.setText("Checksum Exception");
            name.setTextSize(20);
            name.setPadding(10, 20, 10, 2);
            name.setTextColor(Color.BLACK);
            linearLayout.addView(name);
            ...
            name.setText("Formate Exception");
            name.setTextSize(20);
            name.setPadding(10, 20, 10, 2);
            name.setTextColor(Color.BLACK);
            linearLayout.addView(name);
    ...
    public void VcartExteract(String result)
    {
        ...
        adapter=new RecyclerAdapter(IdentifyActivity.this,list);
    ...
    public  void Websearch()
    {
        ...
        intent.putExtra(SearchManager.QUERY, contents);
        startActivity(intent);
    }
